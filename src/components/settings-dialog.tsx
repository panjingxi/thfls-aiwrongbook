                        ...
                        <div className="flex flex-col items-center justify-center space-y-6 py-8 text-center bg-muted/30 rounded-lg border">
                            ...
                            <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-4 w-full sm:w-auto px-4 sm:px-0">
                                <Button variant="outline" asChild className="gap-2 w-full sm:w-auto">
                                    <a href="https://github.com/JingxiPan/wrong-notebook" target="_blank" rel="noopener noreferrer">
                                ...
                                <Button variant="outline" asChild className="gap-2 w-full sm:w-auto">
                                    <a href="https://github.com/JingxiPan/wrong-notebook/releases" target="_blank" rel="noopener noreferrer">
                                ...
                                <Button variant="outline" asChild className="gap-2 w-full sm:w-auto">
                                    <a href="https://github.com/JingxiPan/wrong-notebook/issues" target="_blank" rel="noopener noreferrer">
                            ...
                            <p className="text-xs text-muted-foreground mt-8">
                                {t.settings?.about?.copyright || "© 2025 JingxiPan. All rights reserved."}
                            </p>
                        </div>
                    </TabsContent>
                </Tabs>
